...
There's real linguistics under the joke (phonetic improbability correlates with funniness), which is half of why I made it — the other half is that rerolling for a good one never stops being fun. Vanilla JS, no dependencies, first project I built to be public from day one.
